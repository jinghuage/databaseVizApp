//module: viz.pythonViz -- load python viz to vizdiv placeholder

//namespace: viz (window.viz)
var viz = viz || {};
console.log("name space viz is:", viz);

viz.pythonViz = function() {
  ...
  var myapp = function(){
    ...
    var vizURL = vizBook.url + dashboard.name; // the python server
