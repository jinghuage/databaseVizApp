...
import os
def request_graph(year, style, **kwargs):

    filename = "/data/allstats_ex_finals_"+year+".csv"
    ...
    final_filename = dir_path + "/data/allstats_finals_"+year+".csv"
    ...
    if style=='round':
        ...
        plotround = allrounds[kwargs.get('plotround')]
...
if __name__ == '__main__':
    ...
    plotid, fightml = request_graph('2011', 'round', plotround=roundid)
    #plotid, fightml = request_graph('2011', 'team1', plotteam='Sydney')
